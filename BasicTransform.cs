...
namespace BCSL
{
    public readonly struct BasicTransform
    {
        ...
        public static readonly BasicTransform Identity = new BasicTransform(Vector2.Zero, 0f, Vector2.One);

        public static readonly int SizeInBytes = System.Runtime.InteropServices.Marshal.SizeOf(typeof(BasicTransform));

        public BasicTransform(Vector2 position, float angle, Vector2 scale)
        {
            this.ScaleX = scale.X;
            this.ScaleY = scale.Y;
            this.angle = angle;
        ...
        public BasicTransform(Vector2 position, float angle, float scale)
        {
            this.ScaleX = scale;
            this.ScaleY = scale;
            this.angle = angle;
        ...
        {
            if(obj is BasicTransform other)
            {
