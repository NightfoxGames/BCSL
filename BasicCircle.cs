...
namespace BCSL
{
    public readonly struct BasicCircle
    {
        public readonly Vector2 Center;
        public readonly float Radius;

        public BasicCircle(Vector2 center, float radius)
        {
            this.Center = center;
            this.Radius = radius;
        }

        public BasicCircle(float x, float y, float radius)
        {
            this.Center = new Vector2(x, y);
            this.Radius = radius;
        }

        public bool Equals(BasicCircle other)
        {
        ...
        {
            float distance = BasicMath.Distance(this.Center, point);
            return distance < this.Radius;
        }

        public void GetExtents(out BasicBox box)
        {
            ...
            box = new BasicBox(min, max);
        }


        public static bool FindApproximateBoundingCircle(Vector2[] points, out BasicCircle circle)
        {
            circle = default(BasicCircle);
            ...
            circle = new BasicCircle(cx, cy, radius);
            return true;
        }
