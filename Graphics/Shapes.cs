...
namespace BCSL.Graphics
{
    public sealed class Shapes : IDisposable
    {
        ...
        public void DrawBoxFill_Slow(Vector2 center, float width, float height, float rotation, Vector2 scale, Color color)
        {
            ...
            BasicTransform transform = new BasicTransform(center, rotation, scale);

            Vector2 a = BasicUtil.Transform(new Vector2(left, top), transform);
            Vector2 b = BasicUtil.Transform(new Vector2(right, top), transform);
            Vector2 c = BasicUtil.Transform(new Vector2(right, bottom), transform);
            Vector2 d = BasicUtil.Transform(new Vector2(left, bottom), transform);
        ...
        public void DrawCircleFill(in BasicCircle circle, int points, Color color)
        {
        ...
        public void DrawCircleFill(float x, float y, float radius, int points, Color color)
        {
            ...
            int shapeVertexCount = BasicMath.Clamp(points, MinCirclePoints, MaxCirclePoints);    // The vertex count will just be the number of points requested by the user.
        ...
        public void DrawEllipseFill(BasicEllipse ellipse, int points, Color color)
        {
        ...
        public void DrawEllipseFill(Vector2 center, Vector2 radius, int points, Color color)
        {
            ...
            int shapeVertexCount = BasicMath.Clamp(points, MinElipsePoints, MaxElipsePoints);    // The vertex count will just be the number of points requested by the user.
            int shapeTriangleCount = shapeVertexCount - 2;      // The triangle count of a convex polygon is alway 2 less than the vertex count.
            int shapeIndexCount = shapeTriangleCount * 3;       // The indices count will just be 3 times the triangle count.
        ...
        public void DrawPolygonFill(Vector2[] vertices, int[] triangles, BasicTransform transform, Color color)
        {
            EnsureStarted();
            ...
            for (int i = 0; i < vertices.Length; i++)
            {
                ...
                v = BasicUtil.Transform(v.X, v.Y, transform);
        ...
        public void DrawPolygonFill(Span<Vector2> vertices, int[] triangles, BasicTransform transform, Color color)
        {
            EnsureStarted();
            EnsureSpace(vertices.Length, indices.Length);
        ...
        public void DrawLine_Slowest(Vector2 a, Vector2 b, Color color)
        {
            ...
            DrawBoxFill_Slow(center, 1f, 1f, angle, scale, color);
        }
        ...
        public void DrawLine(float x1, float y1, float x2, float y2, Color color)
        {
            ...
            BasicMath.Normalize(ref e1x, ref e1y);
        ...
        public void DrawCircle(in BasicCircle circle, int points, Color color)
        {
        ...
        public void DrawCircle(float x, float y, float radius, int points, Color color)
        {
            ...
            points = BasicMath.Clamp(points, MinCirclePoints, MaxCirclePoints);
        ...
        public void DrawEllipse(BasicEllipse ellipse, int points, Color color)
        {
        ...
        {
            DrawEllipse(new Vector2(x, y), new Vector2(xRadius, yRadius), points, color);
        }
        ...
        public void DrawEllipse(Vector2 center, Vector2 radius, int points, Color color)
        {
            ...
            points = BasicMath.Clamp(points, MinPoints, MaxPoints);
        ...
        public void DrawPolygon_Slow(Vector2[] vertices, Vector2 position, float rotation, Vector2 scale, Color color)
        {
            ...
            BasicTransform transform = new BasicTransform(position, rotation, scale);
            ...
            for (int i = 0; i < vertices.Length; i++)
            {
                ...
                a = BasicUtil.Transform(a, transform);
                b = BasicUtil.Transform(b, transform);

                DrawLine_Slow(a, b, color);
            }
        }
        ...
        public void DrawPolygon(Vector2[] vertices, Vector2 position, float rotation, Vector2 scale, Color color)
        {
            ...
            DrawLine(x1, y1, firstX, firstY, color);
        }

        public void DrawPolygon(Vector2[] vertices, BasicTransform transform, Color color)
        {
            if (vertices is null || vertices.Length < 3)
            {
                return;
        ...
        public void DrawPolygon(ReadOnlySpan<Vector2> vertices, BasicTransform transform, Color color)
        {
        ...
        public void DrawPolygonTriangles(Vector2[] vertices, int[] triangles, BasicTransform transform, Color color)
        {
            ...
            for (int i = 0; i < triangles.Length; i += 3)
            {
                ...
                a = BasicUtil.Transform(a, transform);
                b = BasicUtil.Transform(b, transform);
                c = BasicUtil.Transform(c, transform);
