...
namespace BCSL.Input
{
    ...
    public sealed class BasicMouse
    {
        private static Lazy<BasicMouse> LazyInstance = new Lazy<BasicMouse>(() => new BasicMouse());

        public static BasicMouse Instance
        {
        ...
        private BasicMouse()
        {
            this.currMouseState = Microsoft.Xna.Framework.Input.Mouse.GetState();
