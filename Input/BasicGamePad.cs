...
namespace BCSL.Input
{
    ...
    public sealed class BasicGamePad
    {
        public static int MaxGamePadCount = 4;

        private static Lazy<BasicGamePad> LazyInstance = new Lazy<BasicGamePad>(() => new BasicGamePad());

        private GamePadState[] currGamePadStates;
        private GamePadState[] prevGamePadStates;

        public static BasicGamePad Instance
        {
        ...
        private BasicGamePad()
        {
            // Get the number of connected GamePads.
            for (int i = 0; i < BasicGamePad.MaxGamePadCount; i++)
            {
                GamePadCapabilities caps = Microsoft.Xna.Framework.Input.GamePad.GetCapabilities(i);
            ...
            {
                this.currGamePadStates[i] = Microsoft.Xna.Framework.Input.GamePad.GetState(i);
        ...
        public void Update()
        {
            ...
            {
                GamePadState state = Microsoft.Xna.Framework.Input.GamePad.GetState(i);
